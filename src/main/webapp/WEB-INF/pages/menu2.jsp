...
<body>
	<ul class="layui-nav">
	  ...
	  <li class="layui-nav-item"><a href="${webRoot }/competition/querySelfByPage" target="main">发布项目</a></li>
	  ...
	  <li class="layui-nav-item"><a href="${webRoot }/awards/querySelfByPage" target="main">获奖通知</a></li>
	</ul>
</body>
