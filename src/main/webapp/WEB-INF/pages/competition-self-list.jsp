 ...
 <div class="schoollogo">
	...
	<div class="main">
	  <div class="layui-btn-group" style="float:right;margin-bottom:10px;">
	    ...
	    <button class="layui-btn layui-btn-primary" id="score">排名&nbsp;<i class="layui-icon">&#xe60a;</i></button>
	  </div>
...
layui.use(['form','layer','jquery'], function(){
  ...
  var layer = layui.layer;
	...
	//添加按钮
	$("#add").click(function(){
		$(location).prop("href","${webRoot}/competition/add");
	});
	...
	$("#update").click(function(){
		...
		$(location).prop("href","${webRoot}/competition/update?id="+$chk.filter(":checked").val());
	});
	...
	$("#score").click(function(){
		...
		$(location).prop("href","${webRoot}/matches/list?id="+$chk.filter(":checked").val());
	});
	...
	$("#delete").click(function(){
		...
		$("form[class='layui-form']").prop("action","${webRoot}/competition/delete");
