...
layui.use(['form','layer','jquery'], function(){
  ...
  var layer = layui.layer;
	...
	//添加按钮
	$("#add").click(function(){
		$(location).prop("href","${webRoot}/notice/add");
	});
	...
	$("#update").click(function(){
		...
		$(location).prop("href","${webRoot}/notice/update?id="+$chk.filter(":checked").val());
	});
	...
	$("#detail").click(function(){
		...
		$(location).prop("href","${webRoot}/notice/detail?id="+$chk.filter(":checked").val());
	});
	...
	$("#delete").click(function(){
		...
		$("form[class='layui-form']").prop("action","${webRoot}/notice/delete");
