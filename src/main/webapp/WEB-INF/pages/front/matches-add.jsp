...
<html>
  ...
  <div style="max-width:1000px;margin:auto;">
 	<form name="competition-form" class="layui-form" action="${webRoot }/front/matches/add" method="POST" enctype="multipart/form-data">
 	<input type="hidden" value="${result.competition.id }" name="competition.id"/>
 	<input type="hidden" value="${result.id }" name="id"/>
 	
 	<div class="title">${result.competition.title }</div>
  	...
  	<div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      ...
	      <input name="attachment"  class="layui-input" type="file" value="${result.attachmentUrl }">
	    </div>
  	</div>
  	<div class="layui-form-item">
	    <div class="layui-input-block">
