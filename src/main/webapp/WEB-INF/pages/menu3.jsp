...
<body>
	<ul class="layui-nav">
	  ...
	  <li class="layui-nav-item"><a href="${webRoot }/notice/querySelfByPage" target="main">系统公告</a></li>
	  <li class="layui-nav-item"><a href="${webRoot }/topic/queryByPage" target="main">话题讨论</a></li>
	  <li class="layui-nav-item"><a href="${webRoot }/users/participant" target="main">参赛者</a></li>
	  <li class="layui-nav-item"><a href="${webRoot }/users/publisher" target="main">发布者</a></li>
	</ul>
</body>
